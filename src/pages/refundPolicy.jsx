    ...
    <PolicyPage
      ...
      sections={[
        ...
        <>
          ...
          <ul style={{ marginLeft: '1.5rem', marginBottom: '1rem', lineHeight: '1.8' }}>
            <li>Log in to your Gulf Talent account</li>
        ...
        <>
          <p style={{ marginBottom: '1rem', lineHeight: '1.6' }}>
            Upon approval of your refund request, we will process the refund within <strong>7-10 business days</strong>. The time it takes for the refund to appear in your account depends on your bank or payment provider and may take an additional 5-10 business days. Gulf Talent is not responsible for delays caused by your financial institution. You will receive a confirmation email once your refund has been processed.
          </p>
        </>,
        <>
        ...
        <>
          <p style={{ marginBottom: '1rem', lineHeight: '1.6' }}>
            Gulf Talent reserves the right to modify this Refund Policy at any time without prior notice. Changes will become effective immediately upon posting to the website. Your continued use of our services following the posting of revised Refund Policy means you accept and agree to the changes. We recommend reviewing this policy periodically to stay informed of any updates.
          </p>
        </>,
        <>
