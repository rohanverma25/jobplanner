...
export default function EducationVerification({ onAuthClick }) {
  return (
    <GenericStaticPage
      topImage={topImg}
      pageTitle="Education History Verification"
      pageDesc={[
        ...
        <b>Benefits of Education History Verification</b>,
      ...
      productHeadingText="Education History Verification"
      priceText="₹ 7,390.00"
      priceValue={7390}
      rightCtaBtn="Buy Now"
