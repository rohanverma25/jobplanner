...
export default function CurrentEmploymentVerification({ onAuthClick }) {
  return (
    <GenericStaticPage
      ...
      productHeadingText="Current Employment Verification"
      priceText="₹ 12,850.00"
      priceValue={12850}
      rightCtaBtn="Buy Now"
