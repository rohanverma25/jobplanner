...
export default function FastForwardingInternational({ onAuthClick }) {
  return (
    <GenericStaticPage
      topImage={topImg}
      pageTitle="Fast Forwarding International"
      pageDesc={[
        "Fast Forwarding International service, we will forward your details to top relevant recruiters & consultant in International. In addition, we also email your profile and details to relevant consultants. Once the recruiter’s requirements are found relevant to your profile, your detail is emailed to these consultants within 10 days of service activation. This relevance is the based on your Functional Area, Location, and Work experience that you specify at the time of placing your order. So you will be getting a best relevant occupation alerts according to your profile. As per the market availability.",
        "Through Fast Forwarding International service your details will be sent to several of recruiters/consultants and they in turn will contact you through the communication you have provided in your registration.",
      ...
      productHeadingText="Fast Forwarding International"
      priceText="₹ 7500.00"
      priceValue={7500}
